...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/LogoPT.jpg" height="40px"></a>
                </div>
        ...
        <section id="content-1-9" class="content-1-9 content-block">
            <div class="container">
                <div class="underlined-title">
                    <h1>Get in Touch</h1>
                    <hr>
                    <h2>Feel free to contact your Doctor</h2>
                </div>
                <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        ...
                        <div class="col-xs-10">
                            <h4>Appointment</h4>
                            <p>You can make the appointment with your doctor within availability time. Doctor will be there for you.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            ...
                            <p>Now everyone can store their records and then check them whenever you want. Easy and convinent.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            ...
                            <p>List of multiple doctors with specialization in their field.A variety that you can check on and interact.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            ...
                            <p>If you are in a state of emergency Don't worry your doctor will help you in the emergency conditions.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            <h4>Medicine</h4>
                            <p>Proper Medication facility will be guided by doctor and reported in your Records. Even any Test Recommendation is available.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            <h4>Healthcare</h4>
                            <p>We care for Less Transmission Risk for anyone and require a proper health care of everyone</p>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">© Amity University 2021 </p>
                <p class="pull-right small"><a href="adminlogin.php">Doc Login</a></p>
            </div>
        </div>
        <!-- footer end -->
    </div>
